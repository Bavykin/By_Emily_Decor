    ...
    <div class="container">
        ...
        <div class="product-wrapper">
            ...
            <div class="description-wrapper">
                ...
                <div class="price">
                    <p>$<?php echo $it['price']; ?>.00 <span class="css_1rem">standard equipment</span></p><button class="custom-btn">Customize</button>
                </div>
                <div class="product__description">
                    <p><?php echo $it['description']; ?></p>
                </div>
                <div class="order">
                    <button class="order-btn" data-item_id="<?php echo $id; ?>">Order</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="comments__text">
                    ...
                    <div class="comments__btn-wrapper" data-current="<?php echo $key + 1 ?>">
                        ...
                        <div class="comments__count">
                            <span class="comments__current" data-current="<?php echo $key + 1 ?>"><?php echo $key + 1 ?></span>/
                            <span class="comments__maximum" data-max="<?php echo count($comments) ?>"><?php echo count($comments) ?></span>
                        </div>
                    </div>
                </div>
            </div>
